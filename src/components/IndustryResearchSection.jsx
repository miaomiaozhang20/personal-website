...
const IndustryResearchSection = () => {
  return (
    <div className="space-y-4">
      ...
      {/* The badge wall as a pinned print rather than a framed card */}
      <div className="max-w-lg bg-white p-3 pb-2 shadow-lg -rotate-1 mt-6">
        <img
      ...
      <a
        href="#/google-2026"
        className="group mt-8 inline-flex items-stretch rounded-lg bg-accent/60 hover:bg-accent transition-colors"
      >
