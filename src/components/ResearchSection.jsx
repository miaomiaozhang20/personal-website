  ...
  const currentPapers = [
    {
      ...
      slidePreview: [
        `${import.meta.env.BASE_URL}crowdless-future-preview.png`,
        `${import.meta.env.BASE_URL}crowdless-future-preview-2.png`
      ],
    },
    {
                  ...
                  {paper.slidePreview ? (
                    Array.isArray(paper.slidePreview) ? (
                      <div className="space-y-0">
                        {paper.slidePreview.map((preview, idx) => (
                          <img
                            key={idx}
                            src={preview}
                            alt={`${paper.title} Preview ${idx + 1}`}
